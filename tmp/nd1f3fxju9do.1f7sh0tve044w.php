            ...
            <!-- form start -->
              ...
              <div class="box-body">
                        ...
                        <div class="col-xs-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="adminid" class="control-label">Admin Account</label>
                                <select name="adminid" id="adminid" class="form-control">
                                <?php foreach (($ALLEMAILS?:array()) as $ae): ?>
                                <option value="<?php echo $ae['userID']; ?>"><?php echo $ae['userEmail']; ?></option>
                                <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
